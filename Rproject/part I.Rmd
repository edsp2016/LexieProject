...
```{r}
people<-read.delim("people.txt", header =T,sep="\t")
...
+ number of reviews
```{r,echo=FALSE}
toma<-read.table("rt.txt", header =T,sep="\t")
...
```{r}
imdb<-read.delim("IMDb.txt",header=T)
imdb<-imdb[-634,]
